            ...
            <div style={{position: 'relative', paddingTop: 40}}>
                ...
                <Grid container spacing={24}>
                    ...
                    <Grid item xs={3} sm={3}>
                        ...
                        >
                            {[...Array(9).keys()].map((i) => {
                                return <MenuItem key={i} value={i + 8}>{i + 8}</MenuItem>;
                            })}
                        </TextField>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={12}>
                        <InputLabel>
                            RF Power Minimum/Medium/Maximum levels - {`${moduleParams.txMinPwr}/${moduleParams.txMidPwr}/${moduleParams.txMaxPwr}`}
                        </InputLabel>

                        <Range marks={{0: '0', 25: '25%', 50: '50%', 75: '75%', 100: '100%'}} allowCross={false}
                               defaultValue={[moduleParams.txMinPwr * 100 / 15, moduleParams.txMidPwr * 100 / 15, moduleParams.txMaxPwr * 100 / 15]}
                               handleStyle={[{backgroundColor: '#f50057'}, {backgroundColor: '#f50057'}, {backgroundColor: '#f50057'}]}
                ...
                <Grid container spacing={24}>
                    ...
                    {[...Array(16).keys()].map((i) => {
                        ...
                        return <Grid item key={i} xs={2} sm={2}>
                            <TextField
                                type='number'
                                name={paramName}
                                label={`Channel ${i + 1}`}
